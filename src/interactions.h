...
/**
 * Scatter a ray with some probabilities according to the material properties. For example, a diffuse surface scatters
 * in a cosine-weighted hemisphere. A perfect specular surface scatters in the reflected ray direction. In order to
 ...
 * or pure-specular.
 * - Pick the split based on the intensity of each material color, and divide branch result by that branch's probability
 * (whatever probability you use).
 *
 * This method applies its changes to the Ray parameter `ray` in place. It also modifies the color `color` of the ray in
 * place.
 */
